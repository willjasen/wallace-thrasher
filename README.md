...
the codename for this project was chosen as "wallace-thrasher", as it is an alias used in the original alex trebek call on lpc 7. from there, it was a natural decision to then call the web app "stretchie".
