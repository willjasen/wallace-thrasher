...
notes on version history can be found on the [version history]({{ site.baseurl }}/version-history) page. browse the Talkin' Whipapedia scrape, comparison, and merge archive on the [wiki data]({{ site.baseurl }}/wiki-data/) page. browse local transcription runs and their review history on the [transcription data]({{ site.baseurl }}/transcription-data/) page. browse the approved changes produced by locally reviewed Whisper merges on the [Whisper data]({{ site.baseurl }}/whisper-data/) page.
