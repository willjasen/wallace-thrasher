...
(function () {
  ...
  style.textContent = `
    #audioFab {
      position: fixed; bottom: var(--footer-controls-offset, 72px); right: 24px; z-index: 9000;
      height: 47px; min-width: 47px; border-radius: 24px;
      background: #5a5a9a; border: 2px solid #9a9adf;
      cursor: pointer; display: flex; flex-direction: row; align-items: center;
      justify-content: center; gap: 7px; padding: 0 14px;
    ...
    #audioFabPanel {
      position: fixed; bottom: calc(var(--footer-controls-offset, 72px) + 65px); right: 24px; z-index: 8999;
